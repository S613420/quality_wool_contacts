          ...
          <div class="card">
            <div class="card-body">
              ...
              <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <dt class="text-sm font-medium text-gray-500">Farm/Business Name</dt>
                  <dd class="mt-1 text-sm text-gray-900">{{ client.name }}</dd>
                </div>
                
                <div>
                  <dt class="text-sm font-medium text-gray-500">Contact Person</dt>
                  <dd class="mt-1 text-sm text-gray-900">{{ client.contactName }}</dd>
                </div>
            ...
            <div class="card-body">
              ...
              <dl class="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <dd class="mt-1 text-sm text-gray-900 whitespace-pre-line">{{ client.address }}</dd>
                </div>
      ...
      >
        ...
        <div class="text-center">
          ...
          <p class="text-sm text-gray-500 mb-6">
            ...
            This action cannot be undone and will also delete all associated pickups.
          </p>
