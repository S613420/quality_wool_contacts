        ...
        <div class="card-body">
          <div class="flex justify-between items-center">
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900">{{ clientsStore.totalClients }}</p>
            </div>
            <div class="text-3xl relative">
              🏪
              <span v-if="clientsStore.totalClients > 0" class="absolute -top-1 -right-1 bg-green-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
                {{ clientsStore.totalClients > 99 ? '99+' : clientsStore.totalClients }}
              </span>
            </div>
          </div>
        </div>
