        ...
        <div class="card-body">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900">{{ stats.todayPickups }}</p>
            </div>
        ...
        <div class="card-body">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold" :class="syncStatusColor">{{ appStore.syncStatus }}</p>
            </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <router-link to="/clients" class="btn btn-secondary">👥 Browse Clients</router-link>
        </div>
      </div>
    </div>
  </div>
