    ...
    <div class="card">
      <div class="card-body">
        <div class="flex flex-col sm:flex-row gap-4">
          <div class="flex-1">
            <input v-model="searchQuery" type="text" placeholder="Search clients..." class="input" />
          </div>
          <select v-model="selectedRegion" class="input sm:w-auto">
    ...
    <div class="card">
      <div class="card-body">
        <div class="text-center py-12 text-gray-500">
          ...
          <p class="text-gray-600 mb-4">Get started by adding your first client contact</p>
          <button class="btn btn-primary">Add Your First Client</button>
        </div>
      </div>
    </div>
  </div>
